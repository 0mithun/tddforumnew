...
{{--                                        <a class="list-group-item active"  href="{{ route('admin.tag') }}">Tags</a>--}}
                                        ...
                                        @if($user->isAdmin)
                                            ...
                                            <a class="list-group-item active"  href="{{ route('admin.privacypolicy') }}">Privacy Policy</a>
                                ...
                                <div class="col-md-9">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body" style="padding-top: 0px">
                                            <form action="{{  route('admin.privacypolicy.update') }}" method="post" class="form-horizontal">
                                                @csrf
                                                <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                                    <label for="body" class="col-md-2 control-label">Privacy Policy  </label>
